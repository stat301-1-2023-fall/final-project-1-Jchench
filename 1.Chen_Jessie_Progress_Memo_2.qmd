...
After this analysis, I think that the variables I could conduct a bivariate analysis on to 

## Bivariate Analysis

In terms of the bivariate analysis, I think I'll first focus on variables related to `final_streams` to see if there are any meaningful relationship. Then, I'll look at whether these variables are characterized by evident trends throughout the years.
