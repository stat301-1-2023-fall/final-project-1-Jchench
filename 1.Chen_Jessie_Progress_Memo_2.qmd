...
![The histogram distirbution is left skewed here and it seems like there are a lot of songs 2014, 2016, and 2017.](plots/year.png)

Next, let's looks at `dance`:

![This histogram seems to have more or less a unimodal normal distribution with the exception of a couple outliers below 25.](plots/dance.png)

Here's the plot for `key`:

![This barchart indicates that](plots/key.png)

Next, let's look at `loud`:

![There are quite a few significant breaks in between the distirbution, but it looks left skewed and relatively unimodal.](plots/loud.png)

Here's the plot for `primary_genre`:

![This barchart indicates that](plots/primary_genre.png)
...
![This barchart indicates that](plots/time_signature.png)
